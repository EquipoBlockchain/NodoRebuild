...
data class VoteSelectionSoul(
    val blockNumber              : Int,
    val selectedOptionNumber     : Int,
    val selectedOptionDefinition : String,
    val votingTimestamp          : String
) {
    @Override
    /**
     * Returns the values stored in order, separated by the '>' symbol.
     *
     * @return [String]
     */
    override fun toString(): String {
        return ("$blockNumber>$selectedOptionNumber>$selectedOptionDefinition>$votingTimestamp")
    }
}
