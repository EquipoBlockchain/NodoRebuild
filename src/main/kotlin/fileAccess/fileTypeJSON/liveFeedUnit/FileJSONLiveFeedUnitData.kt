 ...
 * @return [String]
 * */
fun getJSONLiveFeedUnitPath(): String {
    return "information/votingProcessLiveFeed/"
}
 ...
 * @return [String]
 * */
fun Int.toJSONLiveFeedUnitName(): String {
    return "MAGI${this}LiveFeedUnit"
}
 ...
 * @return [String]
 * */
fun getJSONLiveFeedUnitFormat(): String {
    return ".json"
}